...
function Save-DellMultiPack {
    ...
    Param (
        ...
        #   Filters
        #====================================================================
        [ValidateSet ('X11','X10','X9','X8','X7','X6','X5','X4','X3','X2','X1')]
        [string]$Generation,
    ...
    Process {
        ...
        Publish-OSDDriverScripts -PublishPath (Join-Path $SetOSDDriversPathDownload 'DellModel')
        #===================================================================================================
        #   Get-OSDDrivers
        #===================================================================================================
        $OSDDrivers = @()
        if ($InputObject) {
            ...
            $OSDDrivers = Get-DellModelPack -DownloadPath (Join-Path $SetOSDDriversPathDownload 'DellModel')
            $OSDDrivers | Export-Clixml "$(Join-Path $SetOSDDriversPathDownload $(Join-Path 'DellModel' 'DellModelPack.clixml'))"
        }
        #===================================================================================================
        #   Set-OSDStatus
        #===================================================================================================
